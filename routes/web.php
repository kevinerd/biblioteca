...
Route::get('site/usuario/verify/{token}', array(
    'as' => 'user.verify',
    'uses' => 'UserController@verify'
));

Route::get('site/usuario/{usuario}/resend', array(
    'as' => 'resend',
...
Route::post('site/password/email', array(
    'as' => 'password.email',
...
Route::post('site/password/reset', array(
    'as' => 'password.reset',
...
/* Rutas de usuarios */
Route::get('site/usuario/{usuario}', array(
    'as' => 'site.usuario',
    'uses' => 'UserController@showSite'
))->middleware('auth');

Route::get('site/usuario/edit/{usuario}', array(
    'as' => 'site.usuario.edit',
    'uses' => 'UserController@editSite'
))->middleware('auth');

Route::put('site/usuario/edit/{usuario}', array(
    'as' => 'site.usuario.update',
    'uses' => 'UserController@updateSite'
));